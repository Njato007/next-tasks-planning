...
export default function BoardSetting({data, onUpdate, onClose} : { data: BoardType | undefined, onUpdate: Function, onClose: Function }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="absolute top-0 bottom-0 left-[260px] md:left-[320px]">
            <div className="min-w-[450px] md:w-fit bg-white dark:bg-slate-800 p-3 text-left align-middle shadow-xl transition-all">
                <h2 className="text-lg font-medium leading-6 text-gray-900 dark:text-slate-200">
                    Board setting
                </h2>
                <div className="">
                    <div className="mt-2">
